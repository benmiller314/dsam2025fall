...
* [Homework for next time](#hw):
    - peer review letters
    - [poll on what we'll do after break](https://forms.gle/NWpiZLN5A4VS53Hp9)


## Framing: Intro to workshop + peer review plan {#framing}

Welcome back to our guest mentors! And welcome, everyone, to the third day of presentations! Today is brought to you by _"and...?"_, meaning I'm especially interested in what _arguments_ you're starting to make: what have you been able to do or see that you wouldn't be able to without computers?
...
<details><summary>Peer review partners, in the same order as before</summary>
...
<div class="panel panel-success alert alert-success">
    ...
    Beyond that? I'm <strong><a href="https://forms.gle/NWpiZLN5A4VS53Hp9">taking a poll</a></strong>.
    </div>
</div>
...
<details><summary>I checked this time to make sure these are the same pairings as above!</summary>
    <table class="table table-bordered table-striped">
        <thead>
            <tr>
                <th scope="col"><strong>This person</strong></th>
                <th scope="col"><strong>Reviews</strong></th>
                <th scope="col"><strong>And also reviews</strong></th>
            </tr>
        </thead>
        <tbody>
            <tr>
